...
- Unten links, außerhalb des Rahmens, die Geschwindigkeitsanzeige nach Abbildung 3-8 und der Video-Nahaufnahme `smt-referenz-tacho.jpg` (Video 4:40, Fassung nach Willis Entscheid vom 24.08.2026): rundes Zifferblatt frei auf schwarzem Grund ohne Gehäusering, Skala 40 bis 160 als kräftiges türkises Band, Striche und Zahlen in Zwanzigerschritten außen am Band, rotes Bandende zwischen 140 und 160 wie im Original, weiße Nadel. Die Skalenlücke liegt oben, dort stehen AIRSPEED und darunter KNOTS auf der Zeile von 160 und 40. Einen Sollwert-Marker gibt es wie im Original nicht, der feste Sollwert steht nur im Hinweistext der Missionsseite.
