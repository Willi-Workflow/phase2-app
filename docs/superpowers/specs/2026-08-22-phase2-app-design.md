...
- Totzone, Umkehrung je Rolle und Empfindlichkeit einstellbar, gespeichert je Profil. Die Totzone reicht seit dem 15.09.2026 bis 0,5 statt bis 0,2 (Willis Auftrag): Der Stick der echten Prüfung hat einen spürbar toten Mittelbereich, der sich damit nachstellen lässt. In voller Höhe gilt sie seit demselben Tag nur für die beiden Stickachsen (Regel `totzoneFuer` in `js/kurve.js`): Der Schubhebel hat keine Mittenrast, und eine große tote Mitte würde dort das Fahrtband von Mission 3 in die äußeren Hebelviertel drängen. Ganz ohne tote Mitte stehen Pedale und Schub aber auch nicht da, sie folgen dem Regler bis zur alten Vorgabe von 0,10 und bleiben dann stehen; die Pedale zentrieren sich selbst, und in Mission 2 ist der Schub eine Ratenachse, deren Nadel sonst bei jedem leicht danebenstehenden Hebel wandert. Untergrenze für jede Achse bleibt das feste Rauschtor.
