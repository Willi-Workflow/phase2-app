...
export const MISSIONEN = [
  { nr: 1, name: "Flugzeugverfolgung", kennzahlName: "Wertung %", wertung: false, maximal: 100 },
  { nr: 2, name: "Multitasking Controls", kennzahlName: "Wertung %", wertung: false, maximal: 100 },
